...
def dry(vial, product, ht, Pchamber, Tshelf, dt, eq_cap, nVial):
    ...
    while Lck <= Lpr0:  # Dry the entire frozen product
        ...
        cons = (
            ...
            },  # sublimation front pressure in Torr
            {
                "type": "eq",
                "fun": lambda x: functions.Eq_Constraints(
                    x[0],
            ...
            {
                "type": "eq",
                "fun": lambda x: x[3] - Tsh,
            },  # shelf temperature fixed in degC
            {
                "type": "ineq",
        ...
        bnds = (
            (Pchamber["min"], Pchamber.get("max", None)),
            (None, None),
            (None, None),
            (None, None),
            (None, None),
        ...
        [Pch, dmdt, Tbot, Tsh, Psub, Tsub, Kv] = res[
            "x"
        ]  # Results in Torr, kg/hr, degC, degC, Torr, degC, cal/s/K/cm^2
