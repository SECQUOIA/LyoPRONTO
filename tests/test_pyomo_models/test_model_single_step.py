...
class TestSingleStepModel:
    ...
    def test_model_with_equipment_constraint(
...
class TestSingleStepSolver:
    ...
    def test_solve_with_warmstart(self, standard_vial, standard_product, standard_ht):
        ...
        solution = single_step.solve_single_step(
            model, warmstart_data=warmstart, tee=False
        )
    ...
    @pytest.mark.slow
    def test_optimize_convenience_function(
        self, standard_vial, standard_product, standard_ht
    ):
        ...
        solution = single_step.optimize_single_step(
            standard_vial, standard_product, standard_ht, Lpr0, Lck, tee=False
        )
