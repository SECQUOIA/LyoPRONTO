...
class TestCalcKnownRp:
    ...
    def test_drying_completes(self, standard_setup):
        ...
        assert final_percent_dried >= 99.0, f"Only {final_percent_dried:.1f}% dried"
    ...
    def test_small_vial_dries_faster(
        self,
        small_vial,
        standard_product,
        standard_ht,
    ...
    def test_concentrated_product_takes_longer(
        self,
        standard_vial,
        dilute_product,
        ...
        assert time_concentrated > time_dilute, (
            "Concentrated product should take longer"
        )
...
class TestEdgeCases:
    ...
    def test_very_low_shelf_temperature(self, standard_setup):
        ...
        assert_warning_messages(
            warning_record, ["Chamber pressure setpoint exceeds vapor pressure"]
        )
