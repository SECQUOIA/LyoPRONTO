...
@pytest.mark.parametrize(
    ...
    [
        ...
        "docs/examples/current_main_pressure_optimizer_comparison_output.ipynb",
        "docs/examples/current_main_joint_optimizer_comparison_output.ipynb",
        "docs/examples/dae_optimizer_walkthrough_output.ipynb",
